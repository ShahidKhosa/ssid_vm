...
{
    public partial class ViewBarcode
    {
        ...
        public ViewBarcode(CCoreScannerClass m_pCoreScannerObj)
        {
            try
            {                
                ...
                m_pCoreScanner = m_pCoreScannerObj;
                performGetScanner();                                
            }
            catch (Exception ex)
            {
        ...
        public static string ShowBarcodeLabel(string strXml)
        {
        ...
        private void performGetScanner()
        {
            ...
            string inXml = "<inArgs><scannerID>1</scannerID><cmdArgs><arg-string>XUA-45001-9</arg-string><arg-bool>FALSE</arg-bool><arg-bool>FALSE</arg-bool></cmdArgs></inArgs>";
            string outXml = "";
            int status = STATUS_FALSE;
            ExecCmd(6200, ref inXml, out outXml, out status);
        ...
        private void registerForEvents()
        {
            ...
            {                
                ...
                string outXml = "";
                int status = STATUS_FALSE;
                ExecCmd(1001, ref inXml, out outXml, out status);                
            }
        }
        ...
        private void PerformSoundBeeper()
        {
            try
            {
                string inXml = "<inArgs>" +
        ...
        {
            string strInXml = "<scannerID>1</scannerID>";
